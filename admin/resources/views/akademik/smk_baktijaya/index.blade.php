    ...
    @section('title','SMK Bakti Jaya')
    @section('content')
    
                <div class="page-title">
                    <h3>SMK Bakti Jaya</h3>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('smk_baktijaya.update', ['smk_baktijaya' => $smk_baktijaya[0]->id]) }}" method="post" enctype="multipart/form-data">
                                             @csrf
                                             @method('PUT')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="description" id="description">{{ $smk_baktijaya[0]->description }}</textarea>
                                                    </div>
                                                    <div class="form-group row align-items-center">
                                                            ...
                                                            <div class="col-lg-4 col-4">
                                                                ...
                                                                <input type="hidden" name="image_old" value="{{ $smk_baktijaya[0]->image }}">
                                                                <img style="width: 30%" src="{{ asset('storage/'. $smk_baktijaya[0]->image) }}" alt="" srcset="">
                                                            </div>
