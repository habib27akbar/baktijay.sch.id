                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('visi_misi.update', ['visi_misi' => $visi_misi[0]->id]) }}" method="post" enctype="multipart/form-data">
                                             @csrf
                                             @method('PUT')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="visi" id="visi">{{ $visi_misi[0]->visi }}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="misi" class="form-label">Misi</label>
                                                        <textarea class="form-control" name="misi" id="misi">{{ $visi_misi[0]->misi }}</textarea>
                                                    </div>
                                                    <div class="form-group row align-items-center">
                                                            ...
                                                            <div class="col-lg-4 col-4">
                                                                ...
                                                                <input type="hidden" name="image_old" value="{{ $visi_misi[0]->image }}">
                                                                <img style="width: 30%" src="{{ asset('storage/'. $visi_misi[0]->image) }}" alt="" srcset="">
                                                            </div>
