                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('sekolah.update', ['sekolah' => $data['id']]) }}" method="post" enctype="multipart/form-data">
                                             @csrf
                                             @method('PUT')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row align-items-center">
                                                        <div class="col-lg-2 col-2">
                                                            <label for="keterangan" class="form-label">Nama Sekolah</label>
                                                        </div>
                                                        <div class="col-lg-10 col-10">
                                                            <input type="text" id="keterangan" name="keterangan" class="form-control" value="{{ $data['nama'] }}">
                                                        </div>
                                                    </div>
                                            ...
                                            <a href="{{route('sekolah.index')}}" class="btn btn-default">Kembali</a>
                                        </form>
                                    </div>
                                </div>
