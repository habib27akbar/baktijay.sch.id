                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('waktu.update', ['waktu' => $data['id']]) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                        ...
                                                        <div class="col-lg-8 col-8">
                                                            <select name="hari" id="hari" class="form-control" onchange="changeHari(this.value)">
                                                                ...
                                                                @foreach ($hari as $list_hari)
                                                                    <option {{ $data['hari'] == $list_hari ? 'selected':'' }} value="{{ $list_hari }}">{{ $list_hari }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <select name="jam_awal" id="jam_awal" class="form-control" required>
                                                                    ...
                                                                    @for ($i = 6; $i <= 16; $i++)
                                                                        @if ($i < 10)
                                                                            ...
                                                                            @endphp
                                                                        @endif
                                                                       <option {{ substr($data['jam'], 0,2) == $i?'selected':'' }} value="{{ $i }}">{{ $i }}</option>
                                                                    @endfor
                                                                </select>
                                                                ...
                                                                <select name="menit_awal" id="menit_awal" class="form-control" required>
                                                                    ...
                                                                    @for ($i = 0; $i <= 59; $i++)
                                                                        @if ($i < 10)
                                                                            ...
                                                                            @endphp
                                                                        @endif
                                                                       <option {{ substr($data['jam'], 3,2) == $i?'selected':'' }} value="{{ $i }}">{{ $i }}</option>
                                                                    @endfor
                                                                </select>
                                                            </div>
                                                            <div class="col-md-1" style="width: 3%">
                                                                ...
                                                                <select name="jam_akhir" id="jam_akhir" class="form-control" required>
                                                                    ...
                                                                    @for ($i = 6; $i <= 16; $i++)
                                                                        @if ($i < 10)
                                                                            ...
                                                                            @endphp
                                                                        @endif
                                                                       <option {{ substr($data['jam'], 6,2) == $i?'selected':'' }} value="{{ $i }}">{{ $i }}</option>
                                                                    @endfor
                                                                </select>
                                                                ...
                                                                <select name="menit_akhir" id="menit_akhir" class="form-control" required>
                                                                    ...
                                                                    @for ($i = 0; $i <= 59; $i++)
                                                                        @if ($i < 10)
                                                                            ...
                                                                            @endphp
                                                                        @endif
                                                                       <option {{ substr($data['jam'], 9,2) == $i?'selected':'' }} value="{{ $i }}">{{ $i }}</option>
                                                                    @endfor
                                                                </select>
                                                            </div>
                                                        </div>
