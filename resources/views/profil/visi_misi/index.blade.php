    @extends('layouts.app')
    @if ($visi_misi[0]->image)
        @php
            $image = url('admin/public/storage/'.$visi_misi[0]->image);
        @endphp
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Visi</h6>
                    
                    <p class="mb-4">{!! $visi_misi[0]->visi !!}</p>
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Misi</h6>
                    
                    <p class="mb-4">{!! $visi_misi[0]->misi !!}</p>
